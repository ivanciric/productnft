...
[youtube https://www.youtube.com/watch?v=RwVIi6312t4]
...
- Go to plugin settings and insert your OpenAI API key if you wish to generate AI art for your NFTs.
Otherwise, default product image is used for NFTs.
...
Yes. You can get one at [OpenAI](https://openai.com/blog/openai-api)
You do not need to use AI generated images, you could just use your default product image as an NFT (default option)
